      ...
      for (i = 0; i < buttonsArray.length; i++) {
        ...
        for (y = 0; y < btnGroups.length; y++) {
          ...
          for (z = 0; z < buttons.length; z++) {
            ...
            buttonContainer.text(' ' + this.__localize(btnText)).addClass('btn btn-light btn-sm').addClass(btnClass);
            if (btnClass.match(/btn\-(primary|success|info|warning|danger|link|light)/)) {
              buttonContainer.removeClass('btn-default');
            }
            if (btnClass.match(/btn\-(primary)/)) {
